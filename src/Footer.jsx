...
function Footer() {
  return (
    <div className=" flex gap-5 w-full h-screen bg-zinc-900 px-14 p-8">
      <div className="w-1/2 flex justify-between flex-col h-full Founder">
        <div className="heading">
          <h1 className="text-[9vw] font-semibold uppercase leading-none -mb-8">
            Eye-
          </h1>
          <h1 className="text-[9vw] font-semibold uppercase leading-none -mb-7">
            Opening
          </h1>
        </div>
      ...
      <div className="w-1/2">
        <h1 className=" text-[8.5vw] font-semibold uppercase leading-none Founder">
          PRESENTATIONS
        </h1>
        <div className="dets">
          <a
            className="block text-[1.1vw] font-light color-[#6A6A6A] mb-4 mt-3"
            href=""
          >
            S:
          </a>
          <a className="block text-[1.1vw] font-light color-[#6A6A6A]" href="#">
            Facebook
          </a>
          <a className="block text-[1.1vw] font-light color-[#6A6A6A]" href="#">
            Instagram
          ...
          <a
            className="block text-[1.1vw] font-light color-[#6A6A6A] mb-8"
            href="#"
          >
            Twitter
          </a>
        ...
        <div className="dets  flex justify-between">
          <div>
            <a
              className="block text-[1.1vw] font-light color-[#6A6A6A] mb-4"
              href=""
            >
              L:
            </a>
            <a
              className="block text-[1.1vw] font-light color-[#6A6A6A]"
              href="#"
            >
              202-1965 W 4th Ave
            </a>
            <a
              className="block text-[1.1vw] font-light color-[#6A6A6A] mb-6"
              href="#"
            >
              Vancouver, Canada
            </a>
          ...
          <div className="flex flex-col itesm-start ">
        ...
        <div className="flex flex-col ">
          <a className="underline-offset-1 border-b-white" href="">
            E:
          </a>
